...
public class Config {
    ...
    public void fillEmptyRepository() {
        if (userService.get(1L).isEmpty()) {
            User admin = biuldUser("Jack", "admin", Role.ADMIN, Gender.MALE);
            userService.create(admin);
            User user = biuldUser("Sofia", "qwerty", Role.USER, Gender.FEMALE);
            userService.create(user);
            User guest = biuldUser("John", "123", Role.GUEST, Gender.MALE);
    ...
    private void addDemoQuests (User author){
        ...
        questService.create(
                ...
                """
                        ...
                        4< прямо пойдешь - в разработчики попадешь
                        ...
                        7: Ого. Вот она, большая куча золота.
    ...
    private static User biuldUser(String name, String password, Role role, Gender gender) {
        return User.builder()
                .login(name)
                .password(password)
                .role(role)
