        ...
        <div class="result-score">
            ...
            <div class="score-details">
                <h3>
                    <c:choose>
                        <c:when test="${passed}">
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display: inline-block; margin-right: 8px; vertical-align: middle; color: #48bb78;">
                        ...
                        <c:otherwise>
                            <svg width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" style="display: inline-block; margin-right: 8px; vertical-align: middle; color: #fc8181;">
