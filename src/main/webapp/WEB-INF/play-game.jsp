...
<div class="container">
  ...
  <jsp:useBean id="user" scope="session" type="com.javarush.popkov.entity.User"/>
  <jsp:useBean id="question" scope="request" type="com.javarush.popkov.entity.Question"/>
  <jsp:useBean id="game" scope="request" type="com.javarush.popkov.entity.Game"/>

  <div class="px-3 py-3 my-3 text-left">

    <div class="form-group text-center">
      <img src="<c:url value='/quest-images/${question.image}'/>"
           class="img-fluid"
