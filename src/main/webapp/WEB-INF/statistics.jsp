...
<c:if test="${user.role=='ADMIN'}">
    <div class="container">
        ...
        <table class="table table-striped table-hover">
            ...
            <tbody>
            <c:forEach var="stat" items="${requestScope.usersStatistics}">
                <tr>
        ...
        <div class="row gy-4 row-cols-2 row-cols-md-4">
            <div class="col">
                <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                    ...
                    <div class="px-3">
                        <h2 class="fw-bold mb-0">${requestScope.userStatistics.play}</h2>
            ...
            <div class="col">
                <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                    ...
                    <div class="px-3">
                        <h2 class="fw-bold mb-0">${requestScope.userStatistics.win}</h2>
                        <p class="mb-0">Победа</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                    ...
                    <div class="px-3">
                        <h2 class="fw-bold mb-0">${requestScope.userStatistics.lost}</h2>
                        <p class="mb-0">Поражение</p>
                    </div>
                </div>
            </div>
            <div class="col">
                <div class="text-center d-flex flex-column justify-content-center align-items-center py-3">
                    ...
                    <div class="px-3">
                        <h2 class="fw-bold mb-0">${requestScope.userStatistics.total}</h2>
