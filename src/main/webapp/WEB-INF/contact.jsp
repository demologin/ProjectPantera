    ...
    <div class="container position-relative">
        <div class="row mb-5">
            <div class="col-md-8 col-xl-6 text-center mx-auto">
                ...
                <p class="w-lg-50">Задать вопрос или оставить обратную связь можно заполнив форму ниже.</p>
            </div>
        </div>
                ...
                <div class="d-flex flex-column justify-content-center align-items-start h-100">
                    ...
                    <div class="d-flex align-items-center p-3">
                        ...
                        <div class="px-2">
                            ...
                            <p class="mb-0">dimagoncharov21@gmail.com</p>
                        </div>
                    </div>
                    <div class="d-flex align-items-center p-3">
                        ...
                        <div class="px-2">
                            <h6 class="mb-0">Расположение</h6>
                            <p class="mb-0">1401 N Shoreline Blvd, Mountain View, CA 94043, Соединенные Штаты,
                                Музей компьютерной истории</p>
                        </div>
                    </div>
                </div>
            </div>
            <div class="col-md-6 col-lg-5 col-xl-4">
                <div>
                    <form class="p-3 p-xl-4" method="post">
                        <div class="mb-3"><input class="form-control" type="text" id="name-1" name="name" placeholder="Имя"></div>
                        ...
                        <div><button class="btn btn-primary d-block w-100" type="submit">Отправить </button></div>
                    </form>
                </div>
            </div>
        </div>
